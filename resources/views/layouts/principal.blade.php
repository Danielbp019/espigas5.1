...
<head>
    ...
    <meta name="author" content="Daniel M. Bautista P., col.">
    <title>Espigas</title>
...
<body>
    ...
    <div class="container">
        ...
        <footer>
            <div class="row">
                <div class="col-md-4">
                    <p>Copyright &copy; Sistema Espigas 2012-2016</p>
                </div>
                <div class="col-md-4">
                    <!--vacio-->
                </div>
                <div class="col-md-4">
                    <p style="text-align: right">Paquete de actualización 2024 por Daniel M. Bautista P.</p>
                </div>
            </div>
        </footer>
